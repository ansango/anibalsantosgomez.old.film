...
type Columns = {
  default: keyof ColumnsObject;
  sm: keyof ColumnsObject;
  md: keyof ColumnsObject;
  lg: keyof ColumnsObject;
...
export const Masonry: FC<MasonryProps> = ({ columns, gap, children }) => {
  ...
  const columnsDefault =
    columnsOptionsCn["default"][columns?.default] || columnsOptionsCn["default"]["2"];
  const columnsSm = columnsOptionsCn["sm"][columns?.sm] || columnsOptionsCn["sm"]["2"];
  const columnsMd = columnsOptionsCn["md"][columns?.md] || columnsOptionsCn["md"]["2"];
  const columnsLg = columnsOptionsCn["lg"][columns?.lg] || columnsOptionsCn["lg"]["2"];
  const columnsXl = columnsOptionsCn["xl"][columns?.xl] || columnsOptionsCn["xl"]["2"];
...
export const columnsLg = Object.keys(columnsOptionsCn["lg"]);
export const columnsXl = Object.keys(columnsOptionsCn["xl"]);
export const gapDefault = Object.keys(gapOptionsCn["default"]);
export const gapSm = Object.keys(gapOptionsCn["sm"]);
export const gapMd = Object.keys(gapOptionsCn["md"]);
export const gapLg = Object.keys(gapOptionsCn["lg"]);
export const gapXl = Object.keys(gapOptionsCn["xl"]);
